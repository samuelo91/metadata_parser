...
// This is a hack, simply append stuff
uint16_t extId2; /**< Extension structure id = 0x4531 */
uint16_t extLength2; /**< Extension structure size in 32 bits words excluding the extId and extSize fields */
uint32_t frameTimestampH; /**< Frame timestamp (μs, monotonic), high 32 bits */
uint32_t frameTimestampL; /**< Frame timestamp (μs, monotonic), low 32 bits */
...
uint8_t followMeMode;
uint8_t followMeAnimation;
uint8_t reserved1;
uint8_t reserved2;
uint32_t reserved3;
uint32_t reserved4;
...
uint16_t extLength; /**< Extension structure size in 32 bits words excluding the extId and extSize fields */
uint32_t frameTimestampH; /**< Frame timestamp (μs, monotonic), high 32 bits */
uint32_t frameTimestampL; /**< Frame timestamp (μs, monotonic), low 32 bits */

} MetadataV2TimestampExtension_t;
